...
describe('TimezoneServer', () => {
    ...
    describe('convertTime', () => {
        it('should convert time between timezones correctly', async () => {
            ...
            const result = await server.convertTime(input);
        ...
        it('should handle invalid time format', async () => {
            ...
            await expect(server.convertTime(input)).rejects.toThrow(ConversionError);
        });
        ...
        it('should handle DST transitions', async () => {
            ...
            try {
                await server.convertTime(input);
            }
            catch (error) {
                expect(error).toBeInstanceOf(ConversionError);
                expect(error.type).toBe(ConversionErrorType.SKIPPED_TIME);
            }
